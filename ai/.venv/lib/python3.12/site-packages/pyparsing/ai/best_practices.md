...
- Before developing the pyparsing expressions, define a Backus-Naur Form definition and save this in documentation/grammar.md. Update this document as changes are made in the parser.
