...
- Wrong URL? Verify `VITE_API_BASE_URL` in ui/.env
...
# Kill process using port 5173 (ui)
...
✓ ui/src/         - React components, API clients, stores
...
- **WebSocket Client**: `ui/src/api/socket.ts`
...
Start by:
1. Modifying components in `ui/src/components/`
