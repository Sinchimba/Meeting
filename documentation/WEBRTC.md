...
1. **WebRTCService** (`ui/src/utils/WebRTCService.js`)
...
3. **MeetingRoom Component** (`ui/src/pages/MeetingRoom.jsx`)
...
- [WebRTC API Documentation](https://developer.mozilla.org/en-US/documentation/Web/API/WebRTC_API)
- [RTCPeerConnection Guide](https://developer.mozilla.org/en-US/documentation/Web/API/RTCPeerConnection)
...
- [ICE Candidates](https://developer.mozilla.org/en-US/documentation/Glossary/ICE)
